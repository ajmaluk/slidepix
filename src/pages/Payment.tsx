      ...
      <section className="px-4 py-16 md:py-24">
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          >
            ...
            {clerkEnabled ? (
              <div className="overflow-hidden rounded-[1.75rem] border border-white/10 bg-black/20 p-3">
                <PricingTable for="user" />
              </div>
            ) : (
              <div className="rounded-[1.75rem] border border-dashed border-white/10 bg-black/20 p-6 text-center">
                <p className="text-lg font-semibold text-foreground">Clerk billing is not configured yet</p>
                <p className="mt-2 text-sm leading-6 text-muted-foreground">
                  Set <code className="rounded bg-white/5 px-1.5 py-0.5 text-[11px]">VITE_CLERK_PUBLISHABLE_KEY</code> in your environment to enable the hosted billing table.
                </p>
              </div>
            )}
          </motion.div>
