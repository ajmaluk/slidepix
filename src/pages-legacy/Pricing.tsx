  ...
  return (
    <PageLayout>
      ...
      <section className="max-w-7xl mx-auto px-4 pb-24">
        ...
        <div className="rounded-[2rem] border border-border/30 bg-card/20 px-6 py-14 text-center shadow-[0_30px_120px_-60px_rgba(15,23,42,0.55)]">
          ...
          <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
            {clerkEnabled
              ? "Use the plan cards above to continue into the local payment flow and manage subscriptions through Clerk dashboard configuration."
              : "Set NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY in your environment, then configure plans in the Clerk dashboard to enable billing flows here."}
          </p>
        </div>
      </section>
    </PageLayout>
