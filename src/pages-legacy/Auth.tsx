              ...
              {clerkEnabled ? (
                ...
                <div className="rounded-[1.5rem] border border-dashed border-white/10 bg-black/20 p-6 text-center">
                  ...
                  <p className="mt-2 text-sm leading-6 text-muted-foreground">
                    Set <code className="rounded bg-white/5 px-1.5 py-0.5 text-[11px]">NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY</code> in your environment, then reload to enable sign in and sign up.
                  </p>
